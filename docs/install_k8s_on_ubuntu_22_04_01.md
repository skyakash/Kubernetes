...
1. Create 3 VMs with Ubuntu 22.04.01 LTS, username: akash, machine names: master22, worker122, worker222
2. Install openssh so that we can connect to nodes via ssh
3. Note IP address of VMs
```
